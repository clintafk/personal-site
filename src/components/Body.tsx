...
const userDescription: JSX.Element = (
    <div>
        <p>
            I'm a Computer Science Student @<a href="https://www.xu.edu.ph/">Xavier University Ateneo de Cagayan</a>. I love technology, my areas of interest currently are in <strong>web development</strong>, <strong>game development</strong>, and <strong>cybersecurity</strong>. 
        </p>
        <p>
